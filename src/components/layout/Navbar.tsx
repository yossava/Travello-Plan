        ...
        <div className="flex justify-between h-16">
          ...
          <div className="hidden sm:flex sm:items-center sm:space-x-2">
            {session ? (
              ...
              <>
                ...
                <Link
                  href="/register"
                  className="bg-gradient-to-r from-purple-500 to-pink-500 text-white hover:shadow-lg hover:shadow-purple-500/50 hover:scale-105 px-5 py-2 rounded-lg text-sm font-semibold transition-all duration-300"
                >
                  Get Started
                </Link>
              </>
          ...
          <div className="flex items-center sm:hidden">
            <button
              ...
              className="inline-flex items-center justify-center p-2 rounded-lg text-gray-300 hover:text-white hover:bg-white/10 transition-all"
            >
          ...
          <div className="pt-2 pb-3 space-y-1 px-4">
            {session ? (
              <>
                <Link
                  href="/dashboard"
                  className="block px-4 py-3 text-base font-medium text-gray-300 hover:text-white hover:bg-white/10 rounded-lg transition-all"
              ...
              <>
                ...
                <Link
                  href="/register"
                  className="block px-4 py-3 text-base font-semibold text-center bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-lg hover:shadow-lg hover:shadow-purple-500/50 transition-all"
                  onClick={() => setMobileMenuOpen(false)}
                >
                  Get Started
                </Link>
