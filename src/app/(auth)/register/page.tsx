      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl shadow-2xl p-8">
          <div className="mb-8">
            ...
            <p className="text-gray-300">Start planning your dream trips today</p>
          </div>
            ...
            <div className="flex items-start">
              <div className="flex items-center h-6">
                <input
                  ...
                  onChange={handleChange}
                  className="w-5 h-5 rounded border-2 border-white/20 bg-white/5 text-purple-500 focus:ring-4 focus:ring-purple-500/50 focus:ring-offset-0 transition-all cursor-pointer"
                />
              </div>
